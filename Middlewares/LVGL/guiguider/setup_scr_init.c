...
void setup_scr_init(lv_ui_init *ui){
	...
	lv_style_init(&style_screen_init_progress_bar_main_main_default);
	...
	lv_style_init(&style_screen_init_progress_bar_main_indicator_default);
	...
	lv_label_set_text(ui->screen_init_progress_label, "Starting.......");
	...
	lv_style_init(&style_screen_init_progress_label_main_main_default);
...
{
	lv_bar_set_value(lv_gui_init.screen_init_progress_bar, num, LV_ANIM_OFF);
}
