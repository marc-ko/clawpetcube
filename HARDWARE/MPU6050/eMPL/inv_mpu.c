...
#define MPU6050							// Define IMU as MPU6050
#define MOTION_DRIVER_TARGET_MSP430		// Define target driver as MSP430 (ported to STM32F4)
...
//q30 long to short divider
#define q30  1073741824.0f

// setting of gyro orientation
static signed char gyro_orientation[9] = { 1, 0, 0,
                                           0, 1, 0,
                                           0, 0, 1};
/*
* @brief      Get self test of MPU6050
...
// converting the orientation matrix to scalar
...
// Get data processed by DMP (note, this function requires a lot of stack, and there are many local variables)
// pitch: pitch angle, accuracy: 0.1°, range: -90.0° <---> +90.0°
// roll: roll angle, accuracy: 0.1°, range: -180.0°<---> +180.0°
// yaw: yaw angle, accuracy: 0.1°, range: -180.0°<---> +180.0°
...
u8 mpu_dmp_get_data(float *pitch,float *roll,float *yaw)
{
	...
	**/
	...
	{
		q0 = quat[0] / q30;	// Convert q30 format to float
		q1 = quat[1] / q30;
		q2 = quat[2] / q30;
		q3 = quat[3] / q30; 
		...
		*yaw   = atan2(2*(q1*q2 + q0*q3),q0*q0+q1*q1-q2*q2-q3*q3) * 57.3;	//yaw
		// Since the MPU6050 is located below, the roll needs to be adjusted
