...
// #define MPU_ACCEL_OFFS_REG     0X06    // accel_offs register, can read version number, not mentioned in the register manual
...
#define MPU_ACCEL_XOUTH_REG    0X3B    // Accelerometer value, X-axis high 8-bit register
#define MPU_ACCEL_XOUTL_REG    0X3C    // Accelerometer value, X-axis low 8-bit register
#define MPU_ACCEL_YOUTH_REG    0X3D    // Accelerometer value, Y-axis high 8-bit register
#define MPU_ACCEL_YOUTL_REG    0X3E    // Accelerometer value, Y-axis low 8-bit register
#define MPU_ACCEL_ZOUTH_REG    0X3F    // Accelerometer value, Z-axis high 8-bit register
#define MPU_ACCEL_ZOUTL_REG    0X40    // Accelerometer value, Z-axis low 8-bit register
...
// If the AD0 pin (pin 9) is grounded, the I2C address is 0X68 (excluding the lowest bit).
// If connected to V3.3, the I2C address is 0X69 (excluding the lowest bit).
#define MPU_ADDR               0X68

// When the deviation from the initial posture exceeds this angle, it is considered a shake
#define MPU6050_TURN_ANGLE     20
// Allowable error value when returning to the original position, larger values make it easier to return, smaller values make it more precise
#define MPU6050_RETURN_ANGLE   15

// Because the development board is connected to GND, the read/write address is 0XD1 and 0XD0 (if connected to GND, it is 0XD3 and 0XD2)
